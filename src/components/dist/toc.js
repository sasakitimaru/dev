...
var Toc = function () {
    ...
    return (React.createElement("div", { className: "fixed border-y border-gray-200 dark:border-gray-700 sm:border-none top-12 z-20 sm:z-0 sm:static lg:sticky sm:mx-auto lg:mx-8 sm:mb-4 sm:top-20 p-2 sm:p-4 sm:rounded-lg cursor-pointer select-none w-full sm:w-96 h-fit bg-white dark:bg-gray-800" },
        React.createElement("p", { className: "text-center text-md sm:text-2xl ml-4 font-bold relative\n      before:absolute\n      before:left-3\n      before:content-['\u25B6\uFE0E']\n      before:duration-300\n      " + (isClicked ? "before:rotate-90" : "before:rotate-0") + "\n      ", onClick: function () { return setIsClicked(!isClicked); } }, "\u76EE\u6B21"),
