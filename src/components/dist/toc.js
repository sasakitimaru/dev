...
var Toc = function () {
    ...
    return (React.createElement("div", { className: "border-none z-0 static lg:sticky mx-auto lg:mx-8 mb-8 top-20 p-4 sm:rounded-lg cursor-pointer select-none h-fit w-full sm:w-96 bg-white dark:bg-gray-800" },
