    ...
    return (react_1["default"].createElement("div", { className: "flex flex-col items-center bg-white dark:bg-blue-950" },
        react_1["default"].createElement("footer", { className: "footer p-6 sm:p-10 max-w-6xl" },
            ...
            react_1["default"].createElement("nav", null,
                ...
                react_1["default"].createElement(link_1["default"], { href: "/tags/Java" }, "Java"),
                react_1["default"].createElement(link_1["default"], { href: "/tags/TypeScript" }, "TypeScript"),
                react_1["default"].createElement(link_1["default"], { href: "/tags" }, "others")),
            react_1["default"].createElement("nav", null,
                react_1["default"].createElement("header", { className: "footer-title" }, "Contact"),
                react_1["default"].createElement(link_1["default"], { href: "/about" }, "About"),
