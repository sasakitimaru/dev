...
var Header = function () {
    ...
    return (react_1["default"].createElement(react_1["default"].Fragment, null,
        react_1["default"].createElement("nav", { className: "md:px-24 lg:px-32 px-6 bg-white dark:bg-gray-800 shadow-md flex flex-wrap items-center md:py-2 fixed z-30 w-full top-0 duration-100\n       " + (headerVisible ? "translate-y-0" : "-translate-y-full") + "\n       sm:translate-y-0\n      ", ref: headerRef },
            ...
            react_1["default"].createElement("aside", { className: "flex flex-col items-center justify-cente absolute top-full right-0 w-6/12 text-white\n      " + (isClicked ? "translate-x-0" : "translate-x-full") + " transition-all duration-500 ease-in-out" },
                react_1["default"].createElement("p", { className: "text-xl w-10/12 mt-4 mb-4 pl-4 relative dark:bg-slate-900 py-1\n            before:content-['']\n            before:absolute\n            before:top-0\n            before:left-0\n            before:w-1\n            before:h-full\n            before:bg-blue-500\n          " }, "Menu"),
